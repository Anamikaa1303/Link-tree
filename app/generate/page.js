...
const Generate = () => {
  ...
  return (
    <div className='bg-[#E9C0E9] min-h-[125vh] grid grid-cols-2'>
      ...
      <div className="col1 flex justify-center items-center flex-col text-gray-900">
        <div className='flex flex-col gap-5 my-8'>
          ...
          <div className="item">
            ...
            <div className='mx-4'>
              <input value={handle || ""} onChange={(e) => sethandle(e.target.value)} className="px-4 py-2 my-2 bg-white text-black border border-gray-300 focus:outline-pink-500 rounded-full" type="text" placeholder="Choose a Handle"/>
          ...
          <div className="item">
            ...
            {links && links.map((item, index)=>{
              ...
              <input value={item.link || ""} onChange={e=>{handleChange(index, e.target.value, item.linktext)}} className='px-4 py-2 mx-2 my-2 focus:outline-pink-500 rounded-full bg-white'
          ...
          <div className="item">
            ...
            <div className='mx-4 flex flex-col'>
              ...
              <input value={desc || ""} onChange={e=>{setdesc(e.target.value)}} className='px-4 py-2 mx-2 my-2 focus:outline-pink-500 rounded-full bg-white' type="text" placeholder='Enter description' />
